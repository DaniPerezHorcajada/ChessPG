      ...
      if (piezas[num] == 0){
        ...
        for(var i = 0; i < 16; i++){
          if (blancas[i][2] == origen){
            blancas[i][2] = num;
            //blancas[i][0].animate(1000).attr({x:500, y:500});
        ...
        for(var i = 0; i < 16; i++){
          ...
          socket.emit("movimiento_n", num, i);
            // negras[i][0].animate({x:(num%8)*60, y:(Math.trunc(num/8))*60}, 1000);
            //alert(Math.trunc(num/8));
          }
        }
        return false;
        ...
        // alert(piezas[num]);
        // alert(num);
        // if ((piezas[origen] == "PB" ||  piezas[origen] == "CB" ||  piezas[origen] == "TB" ||
        // piezas[origen] == "AB" ||  piezas[origen] == "QB" ||  piezas[origen] == "KB") &&
        // (piezas[origen] == "PN" ||  piezas[origen] == "CN" ||  piezas[origen] == "TN" ||
        // piezas[origen] == "AN" ||  piezas[origen] == "QN" ||  piezas[origen] == "KN")){
        //   piezas[num] = piezas[origen];
        //   piezas[origen] = 0;
        //   for(var i = 0; i < 16; i++){
        //     if (blancas[i][2] == origen){
